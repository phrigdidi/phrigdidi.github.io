...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // aet data attributes for backgrounds
    ...
    bg3.setAttribute('data-' + ((sectionPositions[1].bottom + sectionPositions[2].bottom) / 2), 'opacity:1;');
    bg3.setAttribute('data-' + sectionPositions[2].bottom, 'opacity:0;');

    bg4.setAttribute('data-' + sectionPositions[2].bottom, 'opacity:0;');
    bg4.setAttribute('data-' + ((sectionPositions[2].bottom + sectionPositions[3].bottom) / 2), 'opacity:1;');
    bg4.setAttribute('data-' + sectionPositions[3].bottom, 'opacity:0;');

    bg5.setAttribute('data-' + sectionPositions[3].bottom, 'opacity:0;');
    bg5.setAttribute('data-' + (sectionPositions[3].bottom + 500), 'opacity:1;');
